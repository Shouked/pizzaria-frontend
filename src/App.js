      ...
      <header className="bg-[#e63946] text-white p-3 flex justify-center items-center shadow-md fixed w-full top-0 z-20">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="bg-green-500 p-2 rounded-full hover:bg-green-600 transition text-sm font-semibold flex items-center"
          >
            <svg
            ...
            {cart.length > 0 && <span className="ml-1 text-white">{cart.length}</span>}
          </button>
        </div>
      </header>
